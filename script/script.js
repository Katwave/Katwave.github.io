...
themeChanger[0].addEventListener("click", () =>{
    ...
    themeChangerMobile.style="display:inline-block"
    themeChanger[0].style="display:none";

    spanHam[0].style="background: #fff";
    spanHam[1].style="background: #fff";
    spanHam[2].style="background: #fff";
    spanHam[3].style="background: #fff";
...
themeChangerMobile.addEventListener("click", () =>{
    ...
    themeChangerMobile.style="display:none; color:#000";
    themeChanger[0].style="display:inline";
    themeChanger[1].style="display:inline";

    spanHam[0].style="background: #000";
    spanHam[1].style="background: #000";
    spanHam[2].style="background: #000";
    spanHam[3].style="background: #000";
